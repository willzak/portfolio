...
export default function Hobbies(props) {
  ...
  return (
    <div className="about-container">
      <div className="paragraph">I have an insatiable appetite for languages, to date I have studied: French, Portuguese, Swedish, Japanese, Russian, and Korean, along with my native English. Although my fluency varies, one thing remains the same - you always look like an idiot when you're learning.</div>
      <br/>
